...
class Tobe:
    ...
    def command_leg_motors(self,angs):
        # this function sends commands to the motors for the 10 lower-leg angles by publishing the commanded angles to the corresponding publisher topics:
