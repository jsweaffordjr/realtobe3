...
class DataOutput:
    def __init__(self):
        ...
        rospy.loginfo("5 seconds until simulated IMU data logging begins...")
        rospy.sleep(5)
        rospy.loginfo("Publishing to topics /simlean and /simpush begins now.")   
...
if __name__ == "__main__":
    rospy.init_node("sim data processing")
    rospy.sleep(1)

    rospy.loginfo("Processing simulated data")
    detect = DataOutput()
